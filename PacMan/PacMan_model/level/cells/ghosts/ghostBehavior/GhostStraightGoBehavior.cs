...
namespace PacMan_model.level.cells.ghosts.ghostBehavior {
    ...
    /// </summary>
    public class GhostStraightGoBehavior : GhostBehavior {
        ...
        public GhostStraightGoBehavior(GhostBehavior parentBehavior,INotChanebleableField field, MovingCell target, GhostBehavior extraBehavior)
            : base(field, target) {
